...
class CrayPE:
    ...
    def _generate_compilers(self, all_compilers):
        ...
        for compiler_module in self._compilers:
            ...
            # todo: currently spack detects nvhpc compilers based on the
            ...
            if compiler_module.name == 'nvidia':
                found_compilers = [c for c in all_compilers if len(c.modules) > 0 and c.name == 'nvhpc' and c.version == Version(compiler_module.version)]
